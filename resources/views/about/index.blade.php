        ...
        <div class="flex flex-wrap p-5 w-full sm:max-w-sm">
            <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div class="flex flex-col items-center pb-10">
                    ...
                    <span class="text-sm md:text-center text-gray-500 dark:text-gray-400 p-5">Who loves to explore new things and is highly enthusiastic about learning, especially in design graphic.Who loves to explore new things and is highly enthusiastic about learning, especially in design graphic.</span>
                    ...
                    <div class="flex mt-4">
                        <a href=""><img src="{{asset('images/linked1.svg')}}" width="30px" class="mt-1 ml-1"></a>
                        <a href=""><img src="{{asset('images/instagram1.svg')}}" width="40px" alt="" class="ml-5" srcset= ""></a>
                    </div>
                </div>
            </div>
