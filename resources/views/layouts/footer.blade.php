<footer class="bg-slate-100 shadow">
    <div class="mx-auto w-full max-w-screen-xl p-4 md:py-8">
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <ul class="bg-w mb-6 flex flex-wrap items-center text-sm font-medium text-slate-600 sm:mb-0">
                <div class="mt-4 flex space-x-6 sm:mt-0 sm:justify-center">
                    <a class="mr-4 hover:underline md:mr-6" href="#">About</a>
                    <a class="hover:underline" href="#">Contact</a>
                    <a class="text-slate-600 hover:text-gray-900" href="#">
        ...
        <span class="block text-sm text-slate-600 sm:text-center">© 2023 <a class="hover:underline"
