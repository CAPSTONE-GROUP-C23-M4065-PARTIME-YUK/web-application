    ...
    <div class="p-10">
        <section class="w-full rounded-lg bg-white dark:bg-gray-900">
            <div class="mx-auto max-w-2xl px-4 py-8 lg:py-16">
                ...
                <form action="{{ route('employer.update', $employers->id) }}" method="POST"
                    ...
                    <div class="mb-4 grid gap-4 sm:mb-5 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input class="focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                                   id="company_name" name="company_name" type="text" value="{{ old('company_name', $employers->company_name) }}"
                                   >
                        ...
                        <div class="sm:col-span-2">
                            <label class="mb-2 block text-sm font-medium text-gray-900" for="file_input">Logo
                                Perusahaan</label>
                            <img src="{{ asset('images/employers-logo/' . $employers->company_logo) }}" alt="{{ $employers->company_name }}" class="border rounded-lg mb-4">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input class="focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                                   id="company_website" name="company_website" type="text" value="{{ old('company_website', $employers->company_website) }}"
                                   >
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input class="focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                                   id="email" name="company_email" type="email" value="{{ old('company_email', $employers->company_email) }}">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input class="focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400"
                                   id="company_phone" name="company_phone" type="text" maxlength="13" value="{{ old('company_phone', $employers->company_phone) }}">
                        ...
                        <div class="sm:col-span-2">
                          ...
                          <input list="province" name="company_province" class="focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400" value="{{ old('company_province', $employers->company_province) }}">
                        ...
                        <div class="sm:col-span-2">
                          ...
                          <input list="regency" name="company_regency" class="focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400" value="{{ old('company_regency', $employers->company_regency) }}">
                          <datalist id="regency">
